...
function e(t){return(e="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(t)}(function(){var t,i,r,s,n,o,l=[].slice;require("@babel/polyfill"),t=!1,r=function(){var e;if(e=1<=arguments.length?l.call(arguments,0):[],t)try{return console.log.apply(console,e)}catch(i){}},(n=require("querystring").parse(location.search.substr(1))).debug&&(t=!0),o=require("lodash"),s=require("nanoid").nanoid,module.exports=i={PREFIX:"xdomls",SESSION:null,options:{expire_polling_ms:100}},n.prefix&&(i.PREFIX=n.prefix),i.ping=function(){return{pong:this._time()}},i.set=i.setItem=function(e,t,i){var s,n;return null==i&&(i=0),e.startsWith(this.PREFIX)||(e=[this.PREFIX,e].join("~")),s={key:n=e.substr((this.PREFIX+"~").length),key_verbose:e,ctime:this._time()},i&&(s.etime=s.ctime+i),s.value=t,localStorage[e]=JSON.stringify(s),r("ifr set",{key:n,val:t}),!0},i.get=i.getItem=function(e,t){var i;if(null==t&&(t=!0),e.startsWith(this.PREFIX)||(e=[this.PREFIX,e].join("~")),i=localStorage[e])return i=JSON.parse(i),t?i.value:i},i.get_all=function(e){var t,i,r,s,n,o,l;for(r in null==e&&(e=!0),t=[],localStorage)n=localStorage[r],r.startsWith(this.PREFIX+"~")&&t.push(JSON.parse(n));if(!e)return t;for(s={},o=0,l=t.length;o<l;o++)s[(i=t[o]).key]=i.value;return s},i.get_expired=function(e){return null==e&&(e=!0),this.expire(),this._expired_keys?e?o.map(this._expired_keys,"key"):this._expired_keys:null},i.del=i.removeItem=function(e){e.startsWith(this.PREFIX)||(e=[this.PREFIX,e].join("~"));try{delete localStorage[e]}catch(t){}return r("ifr del",e.substr((this.PREFIX+"~").length)),!0},i.del_all=i.clear=function(){var e,t;for(t in e=0,localStorage)if(localStorage[t],t.startsWith(this.PREFIX)){if("__session"===t.substr((this.PREFIX+"~").length))continue;e+=1,delete localStorage[t]}return r("ifr clear",e),!0},i.expire=function(){var e,t,i,s;for([],i=0,s=(e=this.get_all(!1)).length;i<s;i++)(t=e[i]).etime&&this._time()>t.etime&&(r("ifr expired key",t.key),this.del(t.key),this._expired_keys.push(t),this._send({expire_key:t.key}));return!0},i.session=function(e){var t;return null==e&&(e=!1),this.get("__session")&&!e||(this.set("__session",t={uuid:s(),ctime:this._time(),prefix:this.PREFIX}),this.SESSION=t,r("ifr new session",t)),this.SESSION=this.get("__session")},i._init=function(){return n.clear&&this.clear(),this.session(),this.expire(),setInterval((e=this,function(){return e.expire()}),this.options.expire_polling_ms);var e},i._listen=function(){return addEventListener("message",(e=this,function(t){var i,r,s,n,o,l;try{i=JSON.parse(t.data)}catch(u){return!1}if((r=null!=(n=i.request)?n.fn:void 0)&&e[r])return s=e[r].apply(e,null!=(o=null!=(l=i.request)?l.args:void 0)?o:[]),e._send(s,i.id)}),!1);var e},i._send=function(t,i){var r;return null==i&&(i=null),"object"!==e(t)&&(t={message:t}),r={response:t},i&&(r.id=i),top.postMessage(JSON.stringify(r),"*")},i._time=function(){return Math.round((new Date).getTime()/1e3)},i._expired_keys=[],module.parent||(i._init(),i._listen(),i._send({message:"rdy",session:i.SESSION,prefix:i.PREFIX}),r("ifr rdy",i.SESSION))}).call(this);
