...
},{"./noConflict":"NL3E","core-js/library/fn/global":"ILDJ"}],"jyMR":[function(require,module,exports) {
...
},{}],"Zorf":[function(require,module,exports) {
...
},{}],"G9z3":[function(require,module,exports) {
"use strict";exports.decode=exports.parse=require("./decode"),exports.encode=exports.stringify=require("./encode");
},{"./decode":"jyMR","./encode":"Zorf"}],"tOLq":[function(require,module,exports) {
...
function t(e){return(t="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(e)}(function(){var e,i,r,n,s=[].slice;require("@babel/polyfill"),i=function(){1<=arguments.length&&s.call(arguments,0)},n=require("querystring").parse(location.search.substr(1)),require("lodash"),r=require("nanoid").nanoid,module.exports=e={PREFIX:"xdls",SESSION:null},e.ping=function(){return{pong:this._time()}},e.set=e.setItem=function(t,e,r){var n,s;return null==r&&(r=0),t.startsWith(this.PREFIX)||(t=[this.PREFIX,t].join("~")),n={key:s=t.substr((this.PREFIX+"~").length),key_verbose:t,ctime:this._time()},r&&(n.etime=n.ctime+r),n.value=e,localStorage[t]=JSON.stringify(n),i("ifr set",{key:s,val:e}),!0},e.get=e.getItem=function(t,e){var i;if(null==e&&(e=!0),t.startsWith(this.PREFIX)||(t=[this.PREFIX,t].join("~")),i=localStorage[t])return i=JSON.parse(i),e?i.value:i},e.get_all=function(t){var e,i,r,n,s,o,l;for(r in null==t&&(t=!0),e=[],localStorage)s=localStorage[r],r.startsWith(this.PREFIX+"~")&&e.push(JSON.parse(s));if(!t)return e;for(n={},o=0,l=e.length;o<l;o++)n[(i=e[o]).key]=i.value;return n},e.del=e.removeItem=function(t){t.startsWith(this.PREFIX)||(t=[this.PREFIX,t].join("~"));try{delete localStorage[t]}catch(e){}return i("ifr del",t.substr((this.PREFIX+"~").length)),!0},e.del_all=e.clear=function(){var t,e;for(e in t=0,localStorage)localStorage[e],e.startsWith(this.PREFIX)&&(t+=1,delete localStorage[e]);return i("ifr clear",t),!0},e.expire=function(){var t,r,n,s,o;for(t=0,s=0,o=(r=this.get_all(!1)).length;s<o;s++)(n=r[s]).etime&&this._time()>n.etime&&(t+=1,e.del(n.key));return t>0&&i("ifr expire",t),!0},e.session=function(){return this.get("__session")||this.set("__session",{uuid:r(),ctime:this._time()}),this.SESSION=this.get("__session")},e._init=function(){return n.clear&&this.clear(),this.expire(),this.session()},e._listen=function(){return addEventListener("message",(t=this,function(e){var i,r,n,s,o,l;if((r=null!=(s=(i=JSON.parse(e.data)).request)?s.fn:void 0)&&t[r])return n=t[r].apply(t,null!=(o=null!=(l=i.request)?l.args:void 0)?o:[]),t._send(n,i.id)}),!1);var t},e._send=function(e,i){var r;return null==i&&(i=null),"object"!==t(e)&&(e={message:e}),r={response:e},i&&(r.id=i),top.postMessage(JSON.stringify(r),"*")},e._time=function(){return Math.round((new Date).getTime()/1e3)},module.parent||(e._init(),e._listen(),e._send({message:"rdy",session:e.SESSION}),i("ifr rdy",new Date))}).call(this);
},{"@babel/polyfill":"JxEC","querystring":"G9z3","lodash":"B1iE","nanoid":"ya15"}]},{},["GnY5"], null)