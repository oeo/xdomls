...
},{"./noConflict":"NL3E","core-js/library/fn/global":"ILDJ"}],"Abjg":[function(require,module,exports) {
...
},{}],"IP0r":[function(require,module,exports) {
...
},{}],"kTWz":[function(require,module,exports) {
"use strict";exports.decode=exports.parse=require("./decode"),exports.encode=exports.stringify=require("./encode");
},{"./decode":"Abjg","./encode":"IP0r"}],"FoA1":[function(require,module,exports) {
...
},{"buffer":"zFQh"}],"kbLt":[function(require,module,exports) {
...
},{"./url-alphabet/index.js":"kbLt"}],"GnY5":[function(require,module,exports) {
function e(t){return(e="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e})(t)}(function(){var t,i,r,n,s,o,l=[].slice;require("@babel/polyfill"),t=!1,r=function(){var e;if(e=1<=arguments.length?l.call(arguments,0):[],t)try{return console.log.apply(console,e)}catch(i){}},(s=require("querystring").parse(location.search.substr(1))).debug&&(t=!0),o=require("lodash"),n=require("nanoid").nanoid,module.exports=i={PREFIX:"xdomls",SESSION:null,options:{expire_polling_ms:100}},s.prefix&&(i.PREFIX=s.prefix),i.ping=function(){return{pong:this._time()}},i.set=i.setItem=function(e,t,i){var n,s;return null==i&&(i=0),e.startsWith(this.PREFIX)||(e=[this.PREFIX,e].join("~")),n={key:s=e.substr((this.PREFIX+"~").length),key_verbose:e,ctime:this._time()},i&&(n.etime=n.ctime+i),n.value=t,localStorage[e]=JSON.stringify(n),r("ifr set",{key:s,val:t}),!0},i.get=i.getItem=function(e,t){var i;if(null==t&&(t=!0),e.startsWith(this.PREFIX)||(e=[this.PREFIX,e].join("~")),i=localStorage[e])return i=JSON.parse(i),t?i.value:i},i.get_all=function(e){var t,i,r,n,s,o,l;for(r in null==e&&(e=!0),t=[],localStorage)s=localStorage[r],r.startsWith(this.PREFIX+"~")&&t.push(JSON.parse(s));if(!e)return t;for(n={},o=0,l=t.length;o<l;o++)n[(i=t[o]).key]=i.value;return n},i.get_expired=function(e){return null==e&&(e=!0),this.expire(),this._expired_keys?e?o.map(this._expired_keys,"key"):this._expired_keys:null},i.del=i.removeItem=function(e){e.startsWith(this.PREFIX)||(e=[this.PREFIX,e].join("~"));try{delete localStorage[e]}catch(t){}return r("ifr del",e.substr((this.PREFIX+"~").length)),!0},i.del_all=i.clear=function(){var e,t;for(t in e=0,localStorage)if(localStorage[t],t.startsWith(this.PREFIX)){if("__session"===t.substr((this.PREFIX+"~").length))continue;e+=1,delete localStorage[t]}return r("ifr clear",e),!0},i.expire=function(){var e,t,i,n;for([],i=0,n=(e=this.get_all(!1)).length;i<n;i++)(t=e[i]).etime&&this._time()>t.etime&&(r("ifr expired key",t.key),this.del(t.key),this._expired_keys.push(t),this._send({expire_key:t.key}));return!0},i.session=function(e){var t;return null==e&&(e=!1),this.get("__session")&&!e||(this.set("__session",t={uuid:n(),ctime:this._time(),prefix:this.PREFIX}),this.SESSION=t,r("ifr new session",t)),this.SESSION=this.get("__session")},i._init=function(){return s.clear&&this.clear(),this.session(),this.expire(),setInterval((e=this,function(){return e.expire()}),this.options.expire_polling_ms);var e},i._listen=function(){return addEventListener("message",(e=this,function(t){var i,r,n,s,o,l;try{i=JSON.parse(t.data)}catch(u){return!1}if((r=null!=(s=i.request)?s.fn:void 0)&&e[r])return n=e[r].apply(e,null!=(o=null!=(l=i.request)?l.args:void 0)?o:[]),e._send(n,i.id)}),!1);var e},i._send=function(t,i){var r;return null==i&&(i=null),"object"!==e(t)&&(t={message:t}),r={response:t},i&&(r.id=i),top.postMessage(JSON.stringify(r),"*")},i._time=function(){return Math.round((new Date).getTime()/1e3)},i._expired_keys=[],module.parent||(i._init(),i._listen(),i._send({message:"rdy",session:i.SESSION,prefix:i.PREFIX}),r("ifr rdy",new Date))}).call(this);
},{"@babel/polyfill":"JxEC","querystring":"kTWz","lodash":"B1iE","nanoid":"ya15"}]},{},["GnY5"], null)