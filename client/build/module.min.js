...
},{"./noConflict":"NL3E","core-js/library/fn/global":"ILDJ"}],"tOLq":[function(require,module,exports) {
...
},{}],"hZYJ":[function(require,module,exports) {
...
},{}],"G7RP":[function(require,module,exports) {
var r={}.toString;module.exports=Array.isArray||function(t){return"[object Array]"==r.call(t)};
},{}],"vOC3":[function(require,module,exports) {
...
},{"base64-js":"tOLq","ieee754":"hZYJ","isarray":"G7RP","buffer":"vOC3"}],"B1iE":[function(require,module,exports) {
var global = arguments[3];
...
},{"buffer":"vOC3"}],"kbLt":[function(require,module,exports) {
...
function n(t){return(n="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(n){return typeof n}:function(n){return n&&"function"==typeof Symbol&&n.constructor===Symbol&&n!==Symbol.prototype?"symbol":typeof n})(t)}(function(){var t,e,r,o,i,l=[].slice;e={Deferrals:function(){function n(n){this.continuation=n,this.count=1,this.ret=null}return n.prototype._fulfill=function(){if(!--this.count)return this.continuation(this.ret)},n.prototype.defer=function(n){return++this.count,t=this,function(){var e,r;return e=1<=arguments.length?l.call(arguments,0):[],null!=n&&null!=(r=n.assign_fn)&&r.apply(null,e),t._fulfill()};var t},n}(),findDeferral:function(){return null},trampoline:function(n){return n()}},require("@babel/polyfill"),r=function(){var n;n=1<=arguments.length?l.call(arguments,0):[];try{return console.log.apply(console,n)}catch(t){}},i=require("lodash"),o=require("nanoid").nanoid,module.exports=t=function(){var t;function r(){return t.apply(this,arguments)}return r.prototype.IFRAME=null,r.prototype.IFRAME_URL=null,r.prototype.READY=!1,r.prototype.SESSION=null,t=function(n){var t,e,r,o,u;for(this.IFRAME_URL=n,u=this,t=function(n){return u[n]=function(){var t,e;return t=1<=arguments.length?l.call(arguments,0):[],"function"==typeof i.last(t)&&(e=t.pop()),u._send({fn:n,args:null!=t?t:[]},e)}},e=0,r=(o=["set","setItem","get","getItem","get_all","del","removeItem","clear"]).length;e<r;e++)t(o[e]);return this},r.prototype.ready=function(n){var t,e,r;return r=this,t=function(n){var t;if(!document.querySelector("#__xdls"))return addEventListener("message",function(t){var e,o;if(t.data,"rdy"===(null!=(e=JSON.parse(t.data))&&null!=(o=e.response)?o.message:void 0))return r.SESSION=r.session=e.response.session,r.READY=!0,n()},!1),(t=document.createElement("iframe")).id="__xdls",t.src=r.IFRAME_URL,t.style.visibility="none",t.style.display="none",r.IFRAME=t,document.body.appendChild(t)},"interactive"===(e=document.readyState)||"complete"===e?t(n):document.addEventListener("DOMContentLoaded",function(){return t(n)})},r.prototype.ping=function(n){return this.READY?this._send("ping",n):n(new Error("Not ready"))},r.prototype.sync=function(t){var r,o,l,u,s,a,f;s=e.findDeferral(arguments),(f=this,function(n){a=new e.Deferrals(n,{parent:s,filename:"/home/taky/www/un/tmp/xdomls/client/src/module.iced",funcname:"Client"}),f._send({fn:"get_all",args:[!0]},a.defer({assign_fn:function(){return r=arguments[0],l=arguments[1]},lineno:78})),a._fulfill()})(function(){if(r)return t(r);if(l)for(o in l)"object"===n(u=l[o])&&(u=JSON.stringify(u)),localStorage[o]=u;return t(null,i.size(l))})},r.prototype._send=function(n,t){var e,r;return null==t&&(t=null),t||(t=function(){return 1}),(e={request:n}).id=r=o(),this.IFRAME.contentWindow.postMessage(JSON.stringify(e),"*"),addEventListener("message",function(e){if((n=JSON.parse(e.data)).id===r)return t(null,n.response)},!1)},r}(),module.parent||(r("client loaded","`window.XDLS`",new Date),window.XDLS=t)}).call(this);
},{"@babel/polyfill":"JxEC","lodash":"B1iE","nanoid":"ya15"}]},{},["GnY5"], null)